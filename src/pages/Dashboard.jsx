import { ArrowRight, KeyboardIcon, PlusIcon, ShieldCheckIcon } from 'lucide-react'
...
const Dashboard = () => {
  ...
  return (
    <div className="flex-1 max-w-7xl w-full mx-auto p-6 md:p-12 flex flex-col">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        {/* Left Column - Actions */}
        <div className="lg:col-span-7 sp[ace-y-8">
              ...
              <form onSubmit={handleJoinMeeting} className="flex-1 flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full bg-white/75 border border-primary-border/60 focus:border-primary/60 focus:ring-1 focus:ring-primary/60 rounded-full pl-12 pr-4 py-3.5 text-sm text-slate-800 placeholder-slate-400 outline-none transition-all"
                  />
                </div>
                <button type="submit" disabled={!joinId.trim()} className="bg-slate-900 hover:bg-slate-800 disabled:opacity-40 disabled:hover:bg-slate-900 text-white font-medium px-6 py-3.5 rounded-full transition-all flex items-center justify-center cursor-pointer shadow-xs disabled:cursor-not-allowed">
                  <span>Join</span>
        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center space-y-4">
          <div className="w-full bg-white/25 backdrop-blur rounded-4xl p-8 border border-slate-200 text-center space-y-6 relative overflow-hidden">
            <div className="space-y-1">
              ...
              <h2 className="text-4xl xl:text-7xl my-4 slate-900 tracking-wide">
                  ...
                  <div className="w-full bg-white/50 rounded-2xl px-5 py-4 border border-slate-100">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-xs text-slate-600 font-mono">
                        {stats.monthlyLimit ? `${stats.monthlyCount} / ${stats.monthlyLimit} Used`
